...
class MenuHelper
{
    ...
    public static function getIconSvg(string $name): string
    {
        $icons = [
            ...
            'building' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 21H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M5 21V5C5 3.89543 5.89543 3 7 3H17C18.1046 3 19 3.89543 19 5V21" stroke="currentColor" stroke-width="1.5"/><path d="M9 7H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14 7H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9 11H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14 11H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9 15H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14 15H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
            'report' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 3H7C5.89543 3 5 3.89543 5 5V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V5C19 3.89543 18.1046 3 17 3H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><rect x="9" y="3" width="6" height="4" rx="1" stroke="currentColor" stroke-width="1.5"/><path d="M9 10H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9 14H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9 18H12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
        ];
