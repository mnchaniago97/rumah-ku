...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="inline-flex items-center gap-3">
                                            <a href="{{ route('admin.sewa.show', $property) }}" class="text-sm font-medium text-brand-600 hover:underline">Detail</a>
                                            <a href="{{ route('admin.sewa.edit', $property) }}" class="text-sm font-medium text-blue-600 hover:underline">Edit</a>
                                            <form action="{{ route('admin.sewa.destroy', $property) }}" method="POST" onsubmit="return confirm('Hapus properti ini?')">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        function setView(view) {
            ...
            localStorage.setItem('sewaViewPreference', view);
        }
        
        // Load saved preference
        document.addEventListener('DOMContentLoaded', function() {
            const savedView = localStorage.getItem('sewaViewPreference') || 'card';
            setView(savedView);
        });
    </script>
@endsection
