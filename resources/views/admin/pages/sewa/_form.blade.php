@php
    ...
    $formAction = $isEdit ? route('admin.sewa.update', $property) : route('admin.sewa.store');
...
<form action="{{ $formAction }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="mt-6 flex gap-4">
        ...
        <a href="{{ route('admin.sewa.index') }}" class="rounded-lg bg-gray-100 px-6 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-200">
            Batal
        </a>
    </div>
</form>
