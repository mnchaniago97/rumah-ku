...
@section('content')
                        ...
                        <div class="rounded-lg bg-white p-4 shadow">
                            ...
                            <div class="mt-8 grid grid-cols-2">
                                 ...
                                 <div class="flex items-center justify-end">
                                     <form action="{{ route('admin.properties.destroy', $property) }}" method="POST" onsubmit="return confirm('Hapus properti ini?')">
                                         @csrf
                                         @method('DELETE')
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="inline-flex items-center gap-3">
                                            <a href="{{ route('admin.properties.show', $property) }}" class="text-sm font-medium text-brand-600 hover:underline">Detail</a>
                                            <form action="{{ route('admin.properties.destroy', $property) }}" method="POST" onsubmit="return confirm('Hapus properti ini?')">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const savedView = localStorage.getItem('propertyViewPreference') || 'card';
            setView(savedView);
        });
    </script>
@endsection
