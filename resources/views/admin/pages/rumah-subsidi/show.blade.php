    ...
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admin.rumah-subsidi.index') }}"
                ...
                <a href="{{ route('admin.rumah-subsidi.edit', $property) }}"
                ...
                <form action="{{ route('admin.rumah-subsidi.destroy', $property) }}" method="POST"
                    ...
                    @foreach($images as $image)
                        ...
                        <div class="group relative aspect-square overflow-hidden rounded-lg">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity">
                                <form action="{{ route('admin.rumah-subsidi.images.destroy', [$property, $image]) }}" method="POST" onsubmit="return confirm('Hapus gambar ini?')">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">Rumah Subsidi</span>
                        </div>
                        <div class="flex items-center justify-between">
