...
@section('content')
    ...
    <div class="bg-gray-50">
        ...
        <div class="relative overflow-hidden">
            <div class="bg-gradient-to-r from-rose-700 via-pink-600 to-rose-500">
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-center">
                        <div class="lg:col-span-6">
                            ...
                            <p class="mt-2 max-w-xl text-sm text-white/90">
                                Dapatkan properti lelang bank dengan harga terjangkau hanya di Rumah Ku.
                            </p>
                        </div>
                        <div class="lg:col-span-6">
                                    ...
                                    <div class="sm:col-span-7">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input name="q" value="{{ $filters['q'] ?? '' }}" placeholder="Cari lokasi / judul properti..."
                                                class="h-11 w-full rounded-xl border border-gray-200 bg-white pl-10 pr-3 text-sm text-gray-800 outline-none focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10" />
                                        </div>
                                    </div>
                                    <div class="sm:col-span-3">
                                        <label class="sr-only">Kota</label>
                                        <select name="city"
                                            class="h-11 w-full rounded-xl border border-gray-200 bg-white px-3 text-sm text-gray-800 outline-none focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10">
        ...
        <div class="mx-auto max-w-[1200px] px-4 py-8">
                        ...
                        <a href="{{ route('property.show', $property->slug ?: $property->getKey()) }}" class="block">
                            <div class="relative aspect-[4/3] bg-gray-200">
                                ...
                                <div class="absolute left-3 top-3 flex items-center gap-2">
                                    <span class="rounded-full bg-rose-600 px-2.5 py-1 text-xs font-semibold text-white">Lelang</span>
            ...
            {{-- About --}}
            <div class="mt-12 rounded-3xl bg-gradient-to-b from-rose-50 to-white p-6 ring-1 ring-rose-100">
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                    ...
                    <div class="lg:col-span-8">
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div class="rounded-2xl bg-white p-5 ring-1 ring-rose-100">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-sm font-bold text-rose-700">Lelang</h4>
                                ...
                                <ol class="mt-4 space-y-2 text-sm text-gray-700">
                                    <li class="flex gap-2"><span class="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-rose-600 text-xs font-bold text-white">1</span> Cari listing yang sesuai</li>
                                    <li class="flex gap-2"><span class="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-rose-600 text-xs font-bold text-white">2</span> Siapkan dokumen dan dana</li>
                                    <li class="flex gap-2"><span class="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-rose-600 text-xs font-bold text-white">3</span> Ikuti proses lelang</li>
                                </ol>
                            </div>
