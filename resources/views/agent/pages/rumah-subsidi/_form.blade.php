@php
    ...
    $formAction = $isEdit ? route('agent.rumah-subsidi.update', $property) : route('agent.rumah-subsidi.store');
...
<form action="{{ $formAction }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div>
            ...
            <input name="building_area" value="{{ old('building_area', $property?->building_area ?? '') }}" type="number" placeholder="36"
                class="h-11 w-full rounded-lg border border-gray-200 bg-transparent px-4 text-sm text-gray-800 focus:border-green-500 focus:outline-hidden focus:ring-3 focus:ring-green-500/10 dark:border-gray-800 dark:text-white" />
        </div>
        ...
        <div>
            ...
            <input name="electricity" value="{{ old('electricity', $property?->electricity ?? '') }}" placeholder="1300 VA"
                class="h-11 w-full rounded-lg border border-gray-200 bg-transparent px-4 text-sm text-gray-800 focus:border-green-500 focus:outline-hidden focus:ring-3 focus:ring-green-500/10 dark:border-gray-800 dark:text-white" />
        </div>
    ...
    <div class="mt-6 flex gap-4">
        ...
        <a href="{{ route('agent.rumah-subsidi.index') }}" class="rounded-lg bg-gray-100 px-6 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-200">
            Batal
        </a>
    </div>
</form>
