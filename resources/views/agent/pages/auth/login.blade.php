@extends('agent.layouts.fullscreen-layout')
                        ...
                        <div>
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                                ...
                                <button
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M22.675 0H1.325C.594 0 0 .594 0 1.326V22.67C0 23.406.594 24 1.325 24H12.82V14.71H9.692V11.1H12.82V8.414C12.82 5.325 14.67 3.62 17.376 3.62C18.674 3.62 19.792 3.716 20.118 3.76V6.987H18.24C16.77 6.987 16.49 7.684 16.49 8.72V11.1H20.01L19.55 14.71H16.49V24H22.675C23.406 24 24 23.406 24 22.675V1.326C24 .594 23.406 0 22.675 0Z"
                                            fill="#1877F2" />
                                    </svg>
                                    Login with Facebook
                                </button>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div x-data="{ checkboxToggle: {{ old('remember') ? 'true' : 'false' }} }">
                                            <label for="checkboxLabelOne"
                                                ...
                                                <div class="relative">
                                                    <input type="checkbox" id="checkboxLabelOne" name="remember" value="1" class="sr-only"
                                                        @change="checkboxToggle = !checkboxToggle" {{ old('remember') ? 'checked' : '' }} />
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href="{{ route('agent.register') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Register</a>
                                </p>
                            </div>
                        </div>
                    </div>
