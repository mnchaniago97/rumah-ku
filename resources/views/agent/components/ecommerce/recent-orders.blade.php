...
<div class="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6" x-data="{ filterOpen: false, selectedStatus: '' }">
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('agent.properties.index') }}" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                Lihat Semua
            </a>
        </div>
    </div>
                    ...
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        <td colspan="4" class="py-8 text-center">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <a href="{{ route('agent.properties.create') }}" class="text-brand-500 hover:underline text-sm font-medium">
