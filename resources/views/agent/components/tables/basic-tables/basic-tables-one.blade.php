    ...
    orders: [
        {
            id: 1,
            user: {
                image: '/assets/admin/images/user/user-17.jpg',
                name: 'Lindsey Curtis',
                role: 'Web Designer',
            },
            ...
            team: {
                images: [
                    '/assets/admin/images/user/user-22.jpg',
                    '/assets/admin/images/user/user-23.jpg',
                    '/assets/admin/images/user/user-24.jpg',
                ],
            },
            budget: '3.9K',
            status: 'Active',
        },
        {
            id: 2,
            user: {
                image: '/assets/admin/images/user/user-18.jpg',
                name: 'Kaiya George',
            ...
            team: {
                images: [
                    '/assets/admin/images/user/user-25.jpg',
                    '/assets/admin/images/user/user-26.jpg',
                ],
            },
            budget: '24.9K',
            status: 'Pending',
        },
        {
            id: 3,
            user: {
                image: '/assets/admin/images/user/user-19.jpg',
                name: 'Zain Geidt',
                role: 'Content Writer',
            },
            ...
            team: {
                images: [
                    '/assets/admin/images/user/user-27.jpg',
                ],
            },
            budget: '12.7K',
            status: 'Active',
        },
        {
            id: 4,
            user: {
                image: '/assets/admin/images/user/user-20.jpg',
            ...
            team: {
                images: [
                    '/assets/admin/images/user/user-28.jpg',
                    '/assets/admin/images/user/user-29.jpg',
                    '/assets/admin/images/user/user-30.jpg',
                ],
            },
            budget: '2.8K',
            status: 'Cancel',
        },
        {
            id: 5,
            user: {
                image: '/assets/admin/images/user/user-21.jpg',
                name: 'Carla George',
            ...
            team: {
                images: [
                    '/assets/admin/images/user/user-31.jpg',
                    '/assets/admin/images/user/user-32.jpg',
                    '/assets/admin/images/user/user-33.jpg',
                ],
            },
            budget: '4.5K',
            status: 'Active',
