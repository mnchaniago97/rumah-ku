...
@php
    $orders = [
        [
            'product' => 'TailGrids',
            'category' => 'UI Kit',
            'countryFlag' => '/assets/admin/images/country/country-01.svg',
            'country' => 'USA',
            'cr' => 'Dashboard',
            'value' => '$12,499',
        ],
        [
            'product' => 'GrayGrids',
            'category' => 'Templates',
            'countryFlag' => '/assets/admin/images/country/country-03.svg',
            'country' => 'UK',
            'cr' => 'Dashboard',
            'value' => '$5,498',
        ],
        [
            'product' => 'Uideck',
            'category' => 'Templates',
            'countryFlag' => '/assets/admin/images/country/country-04.svg',
            'country' => 'Canada',
            'cr' => 'Dashboard',
            'value' => '$4,521',
        ],
        [
            'product' => 'FormBold',
            'category' => 'SaaS',
            'countryFlag' => '/assets/admin/images/country/country-05.svg',
            'country' => 'Australia',
            'cr' => 'Dashboard',
            'value' => '$13,843',
        ],
        [
            'product' => 'NextAdmin',
            'category' => 'Dashboard',
            'countryFlag' => '/assets/admin/images/country/country-06.svg',
            'country' => 'Germany',
            'cr' => 'Dashboard',
            'value' => '$7,523',
        ],
        [
            ...
            'category' => 'SaaS',
            'countryFlag' => '/assets/admin/images/country/country-07.svg',
            'country' => 'France',
            'cr' => 'Dashboard',
            'value' => '$1,377',
        ],
        [
            'product' => 'AyroUI',
            'category' => 'UI Kit',
            'countryFlag' => '/assets/admin/images/country/country-08.svg',
            'country' => 'Japan',
            'cr' => 'Dashboard',
            'value' => '$599,00',
        ],
