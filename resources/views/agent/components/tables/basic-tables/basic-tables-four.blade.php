@php
    $campaigns = [
        [
            'creator' => ['name' => 'Wilson Gouse', 'imageUrl' => '/assets/admin/images/user/user-01.jpg'],
            'brand' => ['name' => 'Brand 1', 'logo' => '/assets/admin/images/brand/brand-01.svg'],
            'title' => 'Grow your brand by...',
            'type' => 'Ads campaign',
            'status' => 'Success',
        ],
        [
            'creator' => ['name' => 'Terry Franci', 'imageUrl' => '/assets/admin/images/user/user-02.jpg'],
            'brand' => ['name' => 'Brand 2', 'logo' => '/assets/admin/images/brand/brand-02.svg'],
            'title' => 'Make Better Ideas...',
            'type' => 'Ads campaign',
            'status' => 'Pending',
        ],
        [
            'creator' => ['name' => 'Alena Franci', 'imageUrl' => '/assets/admin/images/user/user-03.jpg'],
            'brand' => ['name' => 'Brand 3', 'logo' => '/assets/admin/images/brand/brand-03.svg'],
            'title' => 'Increase your website tra...',
            'type' => 'Ads campaign',
            'status' => 'Success',
        ],
        [
            'creator' => ['name' => 'Jocelyn Kenter', 'imageUrl' => '/assets/admin/images/user/user-04.jpg'],
            'brand' => ['name' => 'Brand 4', 'logo' => '/assets/admin/images/brand/brand-04.svg'],
            'title' => 'Digital Marketing that...',
            'type' => 'Ads campaign',
            'status' => 'Failed',
        ],
        [
            'creator' => ['name' => 'Brandon Philips', 'imageUrl' => '/assets/admin/images/user/user-05.jpg'],
            'brand' => ['name' => 'Brand 2', 'logo' => '/assets/admin/images/brand/brand-02.svg'],
            'title' => 'Self branding',
            'type' => 'Ads campaign',
            'status' => 'Success',
        ...
        [
            'creator' => ['name' => 'James Lipshutz', 'imageUrl' => '/assets/admin/images/user/user-06.jpg'],
            'brand' => ['name' => 'Brand 3', 'logo' => '/assets/admin/images/brand/brand-03.svg'],
            'title' => 'Increase your website tra...',
            'type' => 'Ads campaign',
            'status' => 'Success',
